    		...
    		<div class="row justify-content-center">
    			<div class="col-md-10 mb-5 text-center">
    				<ul class="product-category">
                        ...
                        <li><a href="/SnacksBranuedFoods" class="active">SnacksBranuedFoods</a></li>
    				</ul>
    			</div>
    		</div>
    		<div class="row" >
				{% for i in SnacksBreanuedFoods %}
				{% if i.offer_box == 0 %}
            ...
            <div class="text py-3 pb-4 px-3 text-center">
              ...
              <div class="bottom-area d-flex px-3">
                <div class="m-auto d-flex">
                  ...
                  <a href="{% url 'cart' i.id user.id 5 %}" class="buy-now d-flex justify-content-center align-items-center mx-1">
