...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="/index">Bhanu's Ecommers</a>
    ...
    <section class="ftco-section">
    	<div class="container">
    		<div class="row justify-content-center">
              ...
              <li><a href="/DailyBakery">DailyBakery</a></li>
          ...
          {% if ats.offer_box == 1 %}
            <div class="col-md-6 col-lg-3 ftco-animate">
              <div class="product">
              <a href="#" class="img-prod"><img class="img-fluid" src="{{ats.img.url}}" alt="Imge error">
          ...
          {% if ats.offer_box == 0 %}
                <div class="col-md-6 col-lg-3 ftco-animate">
                  <div class="product">
                    <a href="#" class="img-prod"><img class="img-fluid" src="{{ats.img.url}}" alt="Colorlib Template">
                      <div class="overlay"></div>
                    </a>
                    <div class="text py-3 pb-4 px-3 text-center">
                      <h3><a href="#">{{ats.name}}</a></h3>
                      <div class="d-flex">
                        <div class="pricing">
                          <p class="price"><span>₹{{ats.price}}</span></p>
                        </div>
                      </div>
                      <div class="bottom-area d-flex px-3">
                        <div class="m-auto d-flex">
