	    				...
	    				<table class="table">
						    <thead class="thead-primary">
						      <tr class="text-center">
						        ...
						        <th>Quantity</th>
								<th>Total</th>
								<th>Add Changes to Total</th>
						      </tr>
						    </thead>
						    <tbody>
							{% for i in afs %}
						      <tr class="text-center">
						        <td class="product-remove"><a href="{% url 'cart' i.id user.id 10 %}"><span class="ion-ios-close"></span></a></td>
						        
						        <td class="image-prod"><div class="img" style="background-image:url({{i.img.url}});"></div></td>
						        ...
						        <td class="quantity">
									{% csrf_token %}
									<form action="{% url 'cart' i.id user.id 11 %}" method="POST">
										{{i.quantitiy}}<input type="text" name="quantity1" class="quantity form-control input-number" value="{{i.quantity}}"	min="1" max="100">
